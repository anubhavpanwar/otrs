...
$Self->{'AdminEmail'} =  'testotrs9@gmail.com';
...
$Self->{'AgentLoginLogo'} =  {
  'StyleHeight' => '150px',
  'URL' => 'skins/Agent/custom/img/loginlogo1.png'
};
$Self->{'AgentLogo'} =  {
  'StyleHeight' => '75px',
  'StyleRight' => '24px',
  'StyleTop' => '7px',
  'StyleWidth' => '300px',
  'URL' => 'skins/Agent/custom/img/logo2.png'
};
$Self->{'AgentLogoCustom'}->{'custom'} =  {
  'StyleHeight' => '55px',
  'StyleRight' => '29px',
  'StyleTop' => '21px',
  'StyleWidth' => '230px',
  'URL' => 'skins/img/logo2.png'
};
...
$Self->{'CheckEmailValidAddress'} =  '^(testotrs9@gmail.com)$';
$Self->{'CheckMXRecord'} =  '1';
$Self->{'CheckMXRecord::Nameserver'} =  '8.8.8.8';
...
$Self->{'Daemon::SchedulerTaskWorker::NotificationRecipientEmail'} =  'testotrs9@gmail.com';
...
$Self->{'DashboardBackend'}->{'0900-TicketMaster'} =  {
  'Attributes' => 'DynamicField_MasterSlave_Equals=Master;StateType=open;StateType=new;',
  'Block' => 'ContentLarge',
  'CacheTTLLocal' => '0.5',
  'Default' => '1',
  'DefaultColumns' => {
...
$Self->{'DashboardBackend'}->{'0910-TicketSlave'} =  {
  'Attributes' => 'DynamicField_MasterSlave_Like=Slave*;StateType=open;StateType=new;',
  'Block' => 'ContentLarge',
  'CacheTTLLocal' => '0.5',
  'Default' => '1',
  'DefaultColumns' => {
...
$Self->{'FAQ::Voting'} =  '1';
$Self->{'FQDN'} =  'tcs-HP-ProBook-6470b';
...
$Self->{'Frontend::Module'}->{'RunSomething'} =  {
  'Command' => 'touch /opt/otrs/Desktop pp.txt',
  'Module' => 'Kernel::Modules::RunSomething'
};
...
$Self->{'Frontend::Navigation'}->{'AdminSystemConfiguration'}->{'001-Framework'} =  [];
$Self->{'Frontend::Navigation'}->{'AdminSystemConfigurationDeployment'}->{'001-Framework'} =  [];
$Self->{'Frontend::Navigation'}->{'AdminSystemConfigurationGroup'}->{'001-Framework'} =  [];
...
$Self->{'Frontend::Output::FilterContent'}->{'DisableOTRSBusinessNotification'} =  {
  'Module' => 'Kernel::Output::HTML::FilterContent::DisableOTRSBusinessNotification',
  'Templates' => {
    'AgentTicketZoom' => '1'
  }
};
...
$Self->{'Frontend::Output::FilterElementPost'}->{'RemovePackageNotVerifiedNotifications'} =  {
  'Debug' => '0',
  'Module' => 'Kernel::Output::HTML::FilterElementPost::RemovePackageNotVerifiedNotifications',
  'Templates' => {
    'AdminPackageManager' => '1'
  }
};
...
$Self->{'Frontend::ToolBarModule'}->{'130-Ticket::AgentTicketEscalation'} =  {
  ...
  'Link' => 'Action=AgentTicketEscalationView',
  'Module' => 'Kernel::Output::HTML::ToolBar::TicketEscalated',
  'Name' => 'Escalation view',
  'Priority' => '1010030'
};
...
$Self->{'ImportExport::FAQImportExport::ForceCSVMappingRecreation'} =  0;
$Self->{'ImportExport::FormatBackendRegistration'}->{'CSV'} =  {
  'Module' => 'Kernel::System::ImportExport::FormatBackend::CSV',
  'Name' => 'CSV'
};
$Self->{'ImportExport::ObjectBackendRegistration'}->{'FAQ'} =  {
  'Module' => 'Kernel::System::ImportExport::ObjectBackend::FAQ',
  'Name' => 'FAQ'
};
...
$Self->{'Loader::Agent::CommonJS'}->{'127-DisableOTRSBusinessNotification'} =  [
  'DisableOTRSBusinessNotification.js'
];
...
$Self->{'Loader::Agent::Skin'}->{'100-custom'} =  {
  'Description' => 'Lido Tour custom skin.',
  'HomePage' => 'localhost/otrs/index.pl',
  'InternalName' => 'custom',
  'VisibleName' => 'Custom'
};
...
$Self->{'Notification::Transport'}->{'SMS'} =  {
  ...
  'Icon' => 'fa fa-mobile',
  'IsOTRSBusinessTransport' => '1',
  'Module' => 'Kernel::System::Ticket::Event::NotificationEvent::Transport::SMSNotification',
  'Name' => 'SMS (Short Message Service)',
  'Prio' => '120'
};
...
If you did not request a new password, please ignore this email.
            ';
$Self->{'NotificationSenderEmail'} =  'testotrs9@gmail.com';
$Self->{'NotificationSenderName'} =  'OTRS support';
...
$Self->{'Organization'} =  'anubhav Company';
...
$Self->{'Package::RepositoryList'} =  {
  'https://ftp.otrs.org/pub/otrs/itsm/packages6/' => 'OTRS::ITSM 6 Master'
};
...
$Self->{'SendmailModule::AuthPassword'} =  'myotrspw';
$Self->{'SendmailModule::AuthUser'} =  'testotrs9@gmail.com';
$Self->{'SendmailModule::CMD'} =  '/usr/sbin/sendmail -i -f';
$Self->{'SendmailModule::Host'} =  'smtp.gmail.com';
$Self->{'SendmailModule::Port'} =  '587';
$Self->{'SendmailNotificationEnvelopeFrom'} =  '';
$Self->{'SendmailNotificationEnvelopeFrom::FallbackToEmailFrom'} =  '1';
...
$Self->{'Ticket::Frontend::AgentTicketPhone'}->{'SenderType'} =  'agent';
...
$Self->{'Ticket::Frontend::AgentTicketZoom'}->{'ProcessWidgetDynamicFieldGroups'} =  {
  'Employee Data' => 'FirstName,LastName,EmployeeID,BankAccountNumber,Status,Reason,Department,Boss'
};
...
$Self->{'TimeAccounting::DefaultUserDateEnd'} =  '2018-12-31';
$Self->{'TimeAccounting::DefaultUserDateStart'} =  '2018-01-01';
...
$Self->{'ToolBarTicketEscalated::TicketOwner'} =  'me';
